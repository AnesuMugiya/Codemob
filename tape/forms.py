...
class ChannelForm(forms.ModelForm):
    class Meta:
        ...
        widgets={
            'name':forms.TextInput(attrs={'placeholder':'enter your channel name','class':'border rounded py-2 px-4 outline-none focus:shadow-outline'}),
...
class EditChannelForm(forms.ModelForm):
    class Meta:
        ...
        widgets={
            'name':forms.TextInput(attrs={'placeholder':'enter your channel name','class':'border mb-2 rounded py-2 px-4 outline-none focus:shadow-outline'}),
